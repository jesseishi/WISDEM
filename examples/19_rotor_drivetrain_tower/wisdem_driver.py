...
# Set path to geometry, modeling options, and analysis options input files
...
# Turn off WOMBAT to limit computational costs
modeling_options = sch.load_modeling_yaml(fname_modeling_options)
modeling_options["WISDEM"]["OpEx"] = {"flag": False}
new_model_file = sch.write_modeling_yaml(modeling_options, fname_modeling_options)

# Run WISDEM
wt_opt, modeling_options, analysis_options = run_wisdem(
    fname_wt_input, new_model_file, fname_analysis_options
)
